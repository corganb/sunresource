# SunResource - Claude Code Guide

## Site
- URL: https://sunresource.net
- Repo: https://github.com/corganb/sunresource
...
- Cloudflare Pages project name: `sunresource-site`
...
## Sun quirks
- Spacecraft present in scene: Parker Solar Probe, SOHO, Solar Orbiter, SDO, STEREO-A
...
```
wrangler pages deploy public --project-name=sunresource-site --branch=main
```
